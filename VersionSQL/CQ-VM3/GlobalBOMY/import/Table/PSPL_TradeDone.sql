/****** Object:  Table [import].[PSPL_TradeDone]    Committed by VersionSQL https://www.versionsql.com ******/

SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
CREATE TABLE [import].[PSPL_TradeDone](
...
ALTER TABLE [import].[PSPL_TradeDone] ADD  CONSTRAINT [DF_PSPL_TradeDone_ImportedDateTime]  DEFAULT (getdate()) FOR [ImportedDateTime]