/****** Object:  Table [import].[PSPL_ManStockInfo_Archive]    Committed by VersionSQL https://www.versionsql.com ******/

SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
CREATE TABLE [import].[PSPL_ManStockInfo_Archive](
...
ALTER TABLE [import].[PSPL_ManStockInfo_Archive] ADD  CONSTRAINT [DF_PSPL_ManStockInfo_ArchivedDateTime]  DEFAULT (getdate()) FOR [ArchivedDateTime]