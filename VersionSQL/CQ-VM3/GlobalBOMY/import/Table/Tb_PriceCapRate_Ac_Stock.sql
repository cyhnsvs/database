/****** Object:  Table [import].[Tb_PriceCapRate_Ac_Stock]    Committed by VersionSQL https://www.versionsql.com ******/

SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
CREATE TABLE [import].[Tb_PriceCapRate_Ac_Stock](
	...
	[NewCappingByQuantityEffectiveDate1] [varchar](50) NULL,
	[NewCappingByQuantityQuantityCaprate1] [varchar](50) NULL,
	[NewCappingByQuantityMaxQuantityCapping1] [varchar](50) NULL,
	[NewCappingByQuantityNonMarginable1] [varchar](50) NULL,
	[NewCappingByQuantityEffectiveDate2] [varchar](50) NULL,
	[NewCappingByQuantityQuantityCaprate2] [varchar](50) NULL,
	[NewCappingByQuantityMaxQuantityCapping2] [varchar](50) NULL,
	[NewCappingByQuantityProcessBreachNotification] [varchar](50) NULL,
	[NewCappingByQuantityNonMarginable2] [varchar](50) NULL,
