/****** Object:  Table [import].[PSPL_TradeDone_Archive]    Committed by VersionSQL https://www.versionsql.com ******/

SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
CREATE TABLE [import].[PSPL_TradeDone_Archive](
...
ALTER TABLE [import].[PSPL_TradeDone_Archive] ADD  CONSTRAINT [DF_PSPL_TradeDone_Archive_ArchiveDateTime]  DEFAULT (getdate()) FOR [ArchiveDateTime]