/****** Object:  Table [import].[PSPL_StockInfo]    Committed by VersionSQL https://www.versionsql.com ******/

SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
CREATE TABLE [import].[PSPL_StockInfo](
...
ALTER TABLE [import].[PSPL_StockInfo] ADD  CONSTRAINT [DF_PSPL_StockInfo_ImportedDateTime]  DEFAULT (getdate()) FOR [ImportedDateTime]