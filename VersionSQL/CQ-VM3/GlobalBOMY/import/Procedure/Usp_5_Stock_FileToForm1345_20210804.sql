/****** Object:  Procedure [import].[Usp_5_Stock_FileToForm1345_20210804]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [import].[Usp_5_Stock_FileToForm1345_20210804]
AS
/***********************************************************************             
...
BEGIN
	...
	BEGIN TRY
		...
		SELECT 
			...
			-- UPDATE LIMIT
			UPDATE Form
			SET [NetLimit (textinput-47)] = ISNULL(S.NetLimit,0)
