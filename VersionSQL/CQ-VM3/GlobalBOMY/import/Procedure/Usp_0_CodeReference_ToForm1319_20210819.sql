/****** Object:  Procedure [import].[Usp_0_CodeReference_ToForm1319_20210819]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [import].[Usp_0_CodeReference_ToForm1319_20210819] 
AS
/*********************************************************************************** 
...
BEGIN
    ...
    BEGIN TRY
    	BEGIN TRANSACTION
			...
			UNION
			SELECT  'Race' As CodeType, [Description] As RefDesc,LTRIM(RTRIM(RACECD)) As RefCd FROM import.Tb_Race WHERE DESCRIPTION NOT IN ('CORPORATE & BROKER','FOREIGNER','JAPANESE')
			--UNION
		 ...
		 --   UNION
			...
			UNION
			SELECT DISTINCT 'NomAcctName' as RefType, NomineesName1 as RefDesc, LTRIM(RTRIM(NomineesName1)) as RefCd FROM import.Tb_Account WHERE NomineesName1<>'`'
			UNION
