/****** Object:  Procedure [reports].[Usp_ShariahtoNonShariah _SendEmailUpdated_20211101]    Committed by VersionSQL https://www.versionsql.com ******/

  
CREATE PROCEDURE [reports].[Usp_ShariahtoNonShariah _SendEmailUpdated_20211101](    
	@idteDate DATE,
...
BEGIN TRY  
   ...
   --Work Flow Start--
	...
	WHERE A.[multipleradiosinline-3] = 'N' AND JSON_VALUE(B.FormDetails,'$[0].multipleradiosinline3') = 'Y' AND B.LogEvent = 'O'
	--AND CAST(B.AuditDatetime AS DATE) = @idteDate
