/****** Object:  View [report].[Vw_OSPurchaseLossesExceeding_5]    Committed by VersionSQL https://www.versionsql.com ******/

--select * from [report].[VW_OSPURCHASEGAINSEXCEEDING_5]

CREATE VIEW [report].[VW_OSPURCHASELOSSESEXCEEDING_5]
AS
SELECT 
...
((TCP.ClosingPrice - TC.TradedPrice)/TCP.ClosingPrice)*100 AS Losses,
...
INNER JOIN [GLOBALBORPT].[archive].[Tb_ClosingPrice] TCP ON TC.InstrumentId = TCP.InstrumentId