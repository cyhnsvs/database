/****** Object:  Procedure [Queue].[AddMessageToOutBoundQueue_20210826]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [Queue].[AddMessageToOutBoundQueue_20210826] (
...
@Protocol_ETX char(1)=3 --<ETX>
	...
	+'|#~'+'31'+'|#~'+'140'+'|'+		RIGHT(REPLICATE('0',2) + CAST(AccountType as varchar(02) ),2)
	+'|#~'+'31'+'|#~'+'141'+'|'+		CAST(CallWarrantTradingAllowed as varchar(01) )	
	+'|#~'+'31'+'|#~'+'142'+'|'+		CAST(ClientAssociateAllowedFlag as varchar(01) )	
	+'|#~'+'31'+'|#~'+'137'+'|'+		CAST(ShortSellingTradingAllowed as varchar(01) )	
	+ '|#~' + @Protocol_ETX as Msg,
	9 as [Status]
	FROM OPENJSON(@JsonMessageData)
	...
	,ClientCDSNumber  decimal (09)
	,ClientICNumber  varchar (14)
	,BranchID  decimal (03)
	,DealerID  decimal (05)
	,AccountType  decimal (02)
	,CallWarrantTradingAllowed  decimal (01)
	,ClientAssociateAllowedFlag  decimal (01)
	,ShortSellingTradingAllowed  decimal (01)
	) 
	end
	...
	FROM OPENJSON(@JsonMessageData)
	WITH (
	TransactionSequenceNumber  decimal (08)
	,ClientNumber  varchar (09)
	,BranchID  decimal (03)
	,AccessSuspendResume  varchar (01)
	,BuySuspendResume  varchar (01)
