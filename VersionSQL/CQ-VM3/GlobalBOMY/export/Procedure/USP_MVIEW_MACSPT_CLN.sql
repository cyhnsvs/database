/****** Object:  Procedure [export].[USP_MVIEW_MACSPT_CLN]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [export].[USP_MVIEW_MACSPT_CLN]
(
	@idteProcessDate DATE
)
AS
-- ONLINE CLIENT INFO
-- EXEC [export].[USP_MVIEW_MACSPT_CLN] '2020-06-01'
BEGIN
	...
	SELECT 
		...
		LEFT(Customer.[CustomerName (textinput-3)],50) AS CLientName,
	...
	AND 
		ISNULL([OnlineSystemIndicator (multiplecheckboxesinline-2)],'') LIKE '%MV%'
