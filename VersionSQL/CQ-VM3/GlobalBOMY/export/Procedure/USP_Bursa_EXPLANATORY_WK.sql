/****** Object:  Procedure [export].[USP_Bursa_EXPLANATORY_WK]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [export].[USP_Bursa_EXPLANATORY_WK]
(
...
Test Input	: EXEC [export].[USP_Bursa_EXPLANATORY_WK] '2020-06-01'
*/
BEGIN
	...
	SELECT 
		...
		[Notes (textarea-3)]
	FROM CQBTempDB.export.Tb_FormData_3179
