/****** Object:  Procedure [export].[USP_MBMS_606_ClientDeletion]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [export].[USP_MBMS_606_ClientDeletion]
(
