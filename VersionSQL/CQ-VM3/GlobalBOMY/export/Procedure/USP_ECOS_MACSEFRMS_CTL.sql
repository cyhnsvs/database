/****** Object:  Procedure [export].[USP_ECOS_MACSEFRMS_CTL]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [export].[USP_ECOS_MACSEFRMS_CTL]
(
	@idteProcessDate DATE
)
AS
-- CLIENT TRADING LIMIT - OFFLINE CLIENT
-- EXEC [export].[USP_ECOS_MACSEFRMS_CTL] '2020-06-01'
BEGIN
	CREATE TABLE #CTL
	(
		RecordType			CHAR(1),
